const num1 = 123;
const num2 = new Number(123); //객체로 만드는 방법이지만 불필요한 메모리 낭비이므로 지양.
...
// 문자열로 변환
const num4 = 1234.534534;
console.log(num4.toFixed()); //반올림
...
console.log(num4.toPrecision(2));// 전체 자릿수 표기가 안될 때에는 지수표기법
